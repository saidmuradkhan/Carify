        ...
        <div className="detail-layout">
          <div className="detail-gallery">
            <div className="gallery-main">
              <img 
                src={car.sekiller && car.sekiller[selectedImage] ? car.sekiller[selectedImage] : 'https://placehold.co/600x400'} 
                alt={`${car.marka} ${car.model}`} 
              />
            </div>
            {car.sekiller && car.sekiller.length > 1 && (
              <div className="gallery-thumbs">
                {car.sekiller.map((img, index) => (
                  <img 
                    key={index} 
                    src={img} 
